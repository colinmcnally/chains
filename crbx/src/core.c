...
void rebx_register_default_params(struct rebx_extras* rebx){
    ...
    rebx_register_param(rebx, "res_aspectratio0", REBX_TYPE_DOUBLE);
    rebx_register_param(rebx, "res_flaringindex", REBX_TYPE_DOUBLE);
    rebx_register_param(rebx, "res_ffudge", REBX_TYPE_DOUBLE);
    rebx_register_param(rebx, "res_sigma0", REBX_TYPE_DOUBLE);
    rebx_register_param(rebx, "res_alpha", REBX_TYPE_DOUBLE);
    rebx_register_param(rebx, "res_redge", REBX_TYPE_DOUBLE);
