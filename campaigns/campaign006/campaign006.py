...
# Campaign006 definitions
#  Need several tweaks to make Mp=1e-6 work, differen ffudge, tighter spacing of IC, longer relaxation
# 
import numpy as np
import sys
import chaincalc
...
class Campaign006(chaincalc.CampaignBase):
  def __init__(self):
